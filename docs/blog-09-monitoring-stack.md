...
그래서 [PR #63](https://github.com/with-co-talk/co-talk/pull/63)~[#67](https://github.com/with-co-talk/co-talk/pull/67)에 걸쳐 모니터링 스택을 도입했다.
...
## 삽질 1: NAS Docker 볼륨 권한 문제 ([PR #64](https://github.com/with-co-talk/co-talk/pull/64))
...
## 커스텀 비즈니스 메트릭 ([PR #67](https://github.com/with-co-talk/co-talk/pull/67))
...
## 삽질 2: Alertmanager 환경변수 치환 ([PR #65](https://github.com/with-co-talk/co-talk/pull/65))
...
*[PR #63](https://github.com/with-co-talk/co-talk/pull/63)~[#67](https://github.com/with-co-talk/co-talk/pull/67) | 관련 파일: `docker-compose.nas.yml`, `docker/prometheus/`, `docker/alertmanager/`, `docker/loki/`, `docker/promtail/`, `src/main/java/com/cotalk/infrastructure/metrics/CustomMetrics.java`, `src/main/resources/logback-spring.xml`*
