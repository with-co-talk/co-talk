...
이 글은 그 진짜 원인과 최종 해결의 기록이다 ([PR #137](https://github.com/with-co-talk/co-talk/pull/137), 2026-02-26).
...
<!-- IMAGE: GitHub Actions 최종 성공 화면 — [PR #137](https://github.com/with-co-talk/co-talk/pull/137) 머지 후 CI 로그에서 "BUILD SUCCESSFUL in 3m 18s"와 함께 모든 테스트가 통과된 화면. WebSocketChatIntegrationTest 4건이 PASSED로 표시된 부분 포함 -->
...
```
[PR #127](https://github.com/with-co-talk/co-talk/pull/127)  →  [PR #130](https://github.com/with-co-talk/co-talk/pull/130)  →  fix/ci-websocket-auth-import  →  [PR #137](https://github.com/with-co-talk/co-talk/pull/137)
...
<!-- IMAGE: [PR #137](https://github.com/with-co-talk/co-talk/pull/137) 머지 화면 — GitHub PR 페이지에서 "Merged" 보라색 배지와 함께 커밋 목록, 관련 CI 체크가 모두 통과된 상태 스크린샷 -->
