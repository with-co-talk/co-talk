...
> Co-Talk 개발기 시리즈 9편. [PR #99](https://github.com/with-co-talk/co-talk/pull/99)(부하 테스트 시나리오 구성), [PR #100](https://github.com/with-co-talk/co-talk/pull/100)(성능 최적화) 내용을 다룬다.
