...
public class GetSentFriendRequestsService implements GetSentFriendRequestsUseCase {
     ...
     */
    @Override
    public PageResult<FriendRequest> getSentFriendRequests(Long requesterId, PageQuery query) {
        return friendRequestRepository.findPendingByRequesterId(requesterId, query);
    }
}
