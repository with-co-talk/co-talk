    ...
    class MessageHistoryResponseTest {
        ...
        void should_createResponse_when_usingFactoryMethod() {
            ...
            List<MessageDto> messages = List.of(
                    new MessageDto(1L, 10L, "Message 1", "TEXT", LocalDateTime.now(), null, null, null, null, null, null, null),
                    new MessageDto(2L, 10L, "Message 2", "TEXT", LocalDateTime.now(), null, null, null, null, null, null, null)
            );
