    ...
    class MessageHistoryResponseTest {
        ...
        void should_createResponse_when_usingFactoryMethod() {
            ...
            List<MessageDto> messages = List.of(
                    new MessageDto(1L, 10L, "테스트유저", "Message 1", "TEXT", LocalDateTime.now(), null, null, null, null, null, null, null, 0),
                    new MessageDto(2L, 10L, "테스트유저", "Message 2", "TEXT", LocalDateTime.now(), null, null, null, null, null, null, null, 0)
            );
